...
def generator_gatedcnn_v2(inputs, reuse = False, scope_name = 'generator_gatedcnn_v2'):
    ...
    with tf.variable_scope(scope_name) as scope:
        ...
        # Upsample
        u1 = upsample1d_block(inputs = r1, filters = 1024, kernel_size = 5, strides = 1, shuffle_size = 2, name_prefix = 'upsample1d_block1_')
        u2 = upsample1d_block(inputs = u1, filters = 512, kernel_size = 5, strides = 1, shuffle_size = 2, name_prefix = 'upsample1d_block2_')
