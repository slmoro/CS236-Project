...
from module_flow import discriminator, generator_flow
from utils import l1_loss, l2_loss, cross_entropy_loss
from datetime import datetime
import pdb

class FlowCycleGAN(object):

    def __init__(self, num_features, discriminator = discriminator, generator = generator_flow, mode = 'train', log_dir = './log'):
    ...
    def build_model(self):
        ...
        # Place holder for lambda_identity
        ...
        self.generator_loss = self.generator_loss_A2B + self.generator_loss_B2A + self.lambda_identity * self.identity_loss
    ...
    def train(self, input_A, input_B, lambda_identity, generator_learning_rate, discriminator_learning_rate):
        ...
        generation_A, generation_B, generator_loss, _, generator_summaries = self.sess.run(
            ...
            feed_dict = {self.lambda_identity: lambda_identity, self.input_A_real: input_A, self.input_B_real: input_B, self.generator_learning_rate: generator_learning_rate})
    ...
    def summary(self):
        ...
        with tf.name_scope('generator_summaries'):
            ...
            generator_summaries = tf.summary.merge([identity_loss_summary, generator_loss_A2B_summary, generator_loss_B2A_summary, generator_loss_summary])
...
if __name__ == '__main__':
    print('Hello! We are building your model...')
    model = FlowCycleGAN(num_features = 24)
